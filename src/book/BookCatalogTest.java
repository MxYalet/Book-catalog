...
class BookCatalogTest {
	...
	void testAddBook() {
		...
		// First additional test case: Add War and Peace to the catalog
		...
		// Second additional test case: Add Siddhartha to the catalog
	...
	void testGetBookByTitle() {
		...
		// Test case to Get "Siddhartha" by title
		bookCatalog.addBook(this.siddharthaBook);
		...
		//create book with title and add to catalog
		bookLines = new ArrayList<String>();
		bookLines.add("Title: My Son");
		Book book2 = new Book(bookLines);
		bookCatalog.addBook(book2);

		//get book from catalog
		catalogBook = bookCatalog.getBookByTitle("My Son");
		// test book
		assertEquals("My Son", catalogBook.getTitle(), "The expected title does not match the actual title from 'War and Peace' book from the catalog.");
	...
	void testGetBookByAuthor() {
		...
		// First test case: Get "War and Peace" by author
		bookCatalog.addBook(this.warAndPeaceBook);
		...
		//Test case 2
		//create book with title and author and add to catalog
		List<String> bookLines2 = new ArrayList<String>();
		bookLines.add("Title: My Son");
		bookLines.add("Author: Nash Berry");
		Book book2 = new Book(bookLines);
		bookCatalog.addBook(book);
		...
		//get book from catalog
		catalogBook = bookCatalog.getBookByAuthor("Nash Berry");
		// test book
		assertEquals("Nash Berry", catalogBook.getAuthor(), "The expected author does not match the actual author from 'Siddhartha' book from the catalog.");
